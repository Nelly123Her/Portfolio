...
function parsePaths(paths, scale, offset) {
  ...
  for (const path of paths) {
    const segments = path.element.pathSegList, len = (segments == null ? void 0 : segments.numberOfItems) ?? 0, p = {
      x: 0,
      y: 0
    };
    for (let i = 0; i < len; i++) {
...
var PolygonMaskInstance = class {
  constructor(container, engine) {
    this._checkInsidePolygon = (position) => {
      ...
      if (!(options == null ? void 0 : options.enable) || options.type === "none" || options.type === "inline") {
        return true;
      }
      if (!this.raw) {
        throw new Error(noPolygonFound);
      }
      const canvasSize = container2.canvas.size, x = (position == null ? void 0 : position.x) ?? getRandom() * canvasSize.width, y = (position == null ? void 0 : position.y) ?? getRandom() * canvasSize.height;
      let inside = false;
    ...
    this._getEquidistantPointByIndex = (index) => {
      ...
      if (!this.raw || !this.raw.length || !((_a = this.paths) == null ? void 0 : _a.length)) {
      ...
      return {
        x: ((point == null ? void 0 : point.x) ?? 0) * scale + (((_b = this.offset) == null ? void 0 : _b.x) ?? 0),
        y: ((point == null ? void 0 : point.y) ?? 0) * scale + (((_c = this.offset) == null ? void 0 : _c.y) ?? 0)
      };
    };
    ...
    this._getRandomPointByLength = () => {
      ...
      return {
        x: point.x * scale + (((_b = this.offset) == null ? void 0 : _b.x) || 0),
        y: point.y * scale + (((_c = this.offset) == null ? void 0 : _c.y) || 0)
      };
    };
    ...
    this._polygonBounce = (particle, _delta, direction) => {
      const options = this._container.actualOptions.polygon;
      if (!this.raw || !(options == null ? void 0 : options.enable) || direction !== "top") {
        return false;
      }
  ...
  clickPositionValid(position) {
    const options = this._container.actualOptions.polygon;
    return !!(options == null ? void 0 : options.enable) && options.type !== "none" && options.type !== "inline" && this._checkInsidePolygon(position);
  }
  draw(context) {
    var _a;
  ...
  particlePosition(position) {
    var _a;
    const options = this._container.actualOptions.polygon;
    if (!((options == null ? void 0 : options.enable) && (((_a = this.raw) == null ? void 0 : _a.length) ?? 0) > 0)) {
      return;
    }
  ...
  particlesInitialization() {
    const options = this._container.actualOptions.polygon;
    if ((options == null ? void 0 : options.enable) && options.type === "inline" && (options.inline.arrangement === "one-per-point" || options.inline.arrangement === "per-point")) {
      this._drawPoints();
      return true;
    }
    return false;
  ...
  resize() {
    ...
    if (!((options == null ? void 0 : options.enable) && options.type !== "none")) {
      return;
    }
...
var PolygonMaskPlugin = class {
  ...
  needsPlugin(options) {
    var _a, _b;
    return ((_a = options == null ? void 0 : options.polygon) == null ? void 0 : _a.enable) ?? (((_b = options == null ? void 0 : options.polygon) == null ? void 0 : _b.type) !== void 0 && options.polygon.type !== "none");
  }
};
